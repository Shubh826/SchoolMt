...
if (window.innerWidth < 600) {
    // Adjust SumoSelect options for smaller screens
    $('.SumoSelect > .optWrapper > .options').css('max-height', '80px');
} else {
    // Restore default options for larger screens
    $('.SumoSelect > .optWrapper > .options').css('max-height', '80px');
}
            ...
            this.sumo = {
                ...
                createElems: function () {
                    ...
                    if (O.isMobile() && !settings.forceCustomRendering) {
                        alert('max height' + $('.SumoSelect > .optWrapper > .options').css('max-height'));
                        //  $('.SumoSelect > .optWrapper > .options').css('max-height', '50px');
                        // O.E.find('> .optWrapper > .options').css('max-height', '50px');
                        //  alert('after change ' + $('.SumoSelect > .optWrapper > .options').css('max-height'));
                    }
                ...
                setNativeMobile: function () {
                    ...
                    O.E.change(function () {
                        O.setText();
                        // console.log('after change ' + O.E.find('> .optWrapper > .options').css('max-height'));
                    });
                },
