...
function initializeMapCustom() {
    ...
    drawingManager = new google.maps.drawing.DrawingManager({
        ...
        drawingControlOptions: {
           ...
           // drawingModes: [google.maps.drawing.OverlayType.POLYGON, google.maps.drawing.OverlayType.CIRCLE] //as suggested by deepak sir on 9 May 2019
...
function DrawGeofenceEdit(type, radius, centerLat, centerLong, colorCode, polyPoint, order, IsView) {
    //debugger
    //IsView is TRUE if user clicked on 'Edit' button [Updatable], and FALSE if user clicked on 'View' button [Not Updatable]
