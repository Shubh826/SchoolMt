...
namespace DAL
{
    public class SchoolConfigurationDAL
    {
        ...
        public SchoolConfigurationDAL()
        {
            objDataFunctions = new DataFunctions();
        }
        public bool GetSchoolConfigurationData(out List<SchoolConfigurationMDL> List, out BasicPagingMDL objBasicPagingMDL, int id, int rowPerpage, int currentPage, int FK_CompanyId, string SearchBy, string SearchValue)
        {
            List = new List<SchoolConfigurationMDL>();
            ...
            try
            {
                ...
                if (objDataSet.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        List = objDataSet.Tables[1].AsEnumerable().Select(dr => new SchoolConfigurationMDL()
                        {
